  ...
  return (
    <div className="w-full mb-6">
      ...
      <div className="relative h-[2px] w-full bg-stone-200 overflow-hidden">
        <div
          className="h-[2px] transition-all duration-500 ease-out bg-[#082f1e]"
      ...
      <div className="mt-2 flex items-center justify-end gap-2">
        {isAchieved ? (
          <>
            ...
            <p className="font-mono text-[10px] text-[#082f1e] uppercase tracking-wide">
              Gratis Ongkir Berhasil Didapatkan.
            </p>
          </>
        ) : (
          <p className="font-mono text-[10px] text-stone-500 uppercase tracking-wide text-right">
            Belanja {formatPrice(remaining)} lagi untuk Gratis Ongkir.
          </p>
        )}
      </div>
    </div>
