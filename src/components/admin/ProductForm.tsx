        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 py-4 px-1 text-[10px] uppercase tracking-[0.2em] font-medium border-b-2 transition-all whitespace-nowrap ${activeTab === tab.id
            ...
            {activeTab === "info" && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 text-brand-softblack">
                  ...
                  <div>
                    <label className="text-[10px] uppercase tracking-[0.25em] block mb-2 text-brand-softblack/40 font-medium">Koleksi ID (Slug)</label>
                    <input
                      type="text" value={formData.collection_id || ""}
                      onChange={(e) => setFormData({ ...formData, collection_id: e.target.value })}
                      className="w-full bg-transparent border-b border-brand-softblack/10 py-3 text-brand-softblack font-light focus:border-brand-green outline-none transition-colors"
            ...
            <div className="p-8 bg-brand-softblack text-brand-offwhite rounded-sm space-y-8">
              ...
              <div className="space-y-4 pt-2">
                ...
                >
                  ...
                  <option value="vegano">Ethical / Vegan</option>
