...
export default function CheckoutError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("[Batas Error Checkout]", error.message, error.digest);
  }, [error]);
    ...
    >
      <div className="max-w-md text-center">
        ...
        <p className="text-sm font-light opacity-80 mb-8 leading-relaxed">
          Terjadi kendala saat memuat checkout. Keranjang Anda tetap aman.
          Coba lagi, atau hubungi tim kami jika masalah berlanjut.
        </p>
